...
enum
{
    SDL_CONTROLLER_BUTTON_PS5_MIC = SDL_GAMEPAD_BUTTON_MISC1,
    SDL_CONTROLLER_BUTTON_PS5_LEFT_PADDLE = SDL_GAMEPAD_BUTTON_RIGHT_PADDLE1,
    SDL_CONTROLLER_BUTTON_PS5_RIGHT_PADDLE = SDL_GAMEPAD_BUTTON_LEFT_PADDLE1,
    SDL_CONTROLLER_BUTTON_PS5_RIGHT_FUNCTION = SDL_GAMEPAD_BUTTON_RIGHT_PADDLE2,
    SDL_CONTROLLER_BUTTON_PS5_LEFT_FUNCTION = SDL_GAMEPAD_BUTTON_LEFT_PADDLE2,
    SDL_CONTROLLER_BUTTON_PS5_TOUCHPAD = SDL_GAMEPAD_BUTTON_TOUCHPAD
};
